...
public class ShortQuizResult {
    ...
    private String difficculty;

    public ShortQuizResult(int id, int questionsAmount, int correctAnswers,
                           Date createdAt, String category, String difficculty) {
        this.id = id;
        this.questionsAmount = questionsAmount;
        this.correctAnswers = correctAnswers;
        this.createdAt = createdAt;
        this.category = category;
        this.difficculty = difficculty;
    }
    ...
    public String getDifficculty() {
        return difficculty;
    }

    public void setDifficculty(String difficculty) {
        this.difficculty = difficculty;
    }
}
